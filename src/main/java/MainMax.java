...
public class MainMax {
    final static String URL = "http://elmadev.gazprom-media.ru";
    ////////////////////////////////////////////////////////////////////////////////////////////////////
    ...
    public MainMax clickShowInputField() {
        //метод нажимает на кнопку заказать
        btnShowInputField.click();
        return this;
    }

    public MainMax inputOrderNum(String incorrectOrderNum) {
